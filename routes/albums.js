...
router.post('/albums', function(req, res, next) {
  Albums().insert({ artist: req.body.album_name,  name: req.body.album_title, genre: req.body.genre, stars: req.body.star_rating, explicit: req.body.explicit }).then(function () {
    res.redirect('/albums');
  });
});
...
router.put('/albums/:id/update', function(req, res, next) {
  Albums().where({ id: req.params.id }).update({
    artist: req.body.album_name,
    name: req.body.album_title,
